...
* previous season standings with relegated annotation ([497771d](https://github.com/quantti/tapas-fpl-app/commit/497771db4e109c4f03a320d8679738e775e690e1))

## [0.40.1](https://github.com/quantti/tapas-fpl-app/compare/v0.40.0...v0.40.1) (2026-08-13)


### Bug Fixes

* redesign relegated arrow to match emoji style, fix sizing ([b795081](https://github.com/quantti/tapas-fpl-app/commit/b7950814f0f5397c105744d639085011f1d8ff85))
...
* **backend:** run dashboard queries sequentially to avoid asyncpg error ([a933074](https://github.com/quantti/tapas-fpl-app/commit/a9330740b7a4e19033993ec4731a3cf7ac93ab7a))
...
* **backend:** run DB queries sequentially to avoid asyncpg error ([a501475](https://github.com/quantti/tapas-fpl-app/commit/a5014751149cf6b0da6ad2f73b607eabf4cc7b3f))
