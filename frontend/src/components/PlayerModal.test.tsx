...
import * as usePlayerDetailsModule from '../hooks/usePlayerDetails'
import type { Player, Team, ElementType } from '../types/fpl'

// Mock the usePlayerDetails hook
vi.mock('../hooks/usePlayerDetails', async () => {
  const actual = await vi.importActual('../hooks/usePlayerDetails')
  return {
    ...actual,
